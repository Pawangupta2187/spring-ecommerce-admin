...
import com.admin.admin.entities.users.DTO.SellerProfileDTO;
...
public interface RegisterSellerRepository extends PagingAndSortingRepository<Seller,Long> {
    ...
    @Query("select new com.admin.admin.entities.users.DTO.sellerdto(s.id,s.firstName," +
    ...
    List<Seller> findallseller(Pageable pageable);
      ...
      @Query("select new com.admin.admin.entities.users.DTO.SellerProfileDTO(" +
